...
# Rscript all_pipeline_genes_fastSemSim.R [<metric>]
# Rscript all_pipeline_genes_fastSemSim.R Resnik
# Rscript all_pipeline_genes_fastSemSim.R SimGIC
...
outFold <- file.path("ALL_GENES_FASTSEMSIM")
system(paste0("mkdir -p ", outFold))

logFile <- file.path(outFold, "allGenesFastSemSim_logFile.txt")
...
fastSemSim_resultFile <- file.path(outFold, "output", paste0("all_datasets", "_", fss_ontType, "_", fss_root, "_", fss_metric, "_", fss_mixStrategy, "_result_file.txt"))
